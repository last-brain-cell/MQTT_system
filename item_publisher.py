...
# Random Items Data for Random Picking for rudimentry testing - Temporary arrangement for now, in reality, the data will be read from a csv for priliminary testing
